ActionController::Routing::Routes.draw do |map|
  ...
  map.connect   '/vendas/venda_financa_contado',      :controller=>'vendas',            :action=>'venda_financa_contado';
  ...
  map.connect   '/relatorios/livro_mayor_cliente',                :controller=>'relatorios',        :action=>'livro_mayor_cliente';
  ...
  map.resources :relatorios, :collection  => { :resultado_relatorio_vendas_do_dia    => :get,
                                               ...
                                               :resultado_livro_mayor_cliente        => :get,
