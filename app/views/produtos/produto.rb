class Produto < ActiveRecord::Base
  ...
  def self.busca_produto(params)
    ...
    Produto.all( :select => 'id,clase_id,grupo_id,nome,barra,stock_minimo,stock_maximo,stock_inicial,preco_venda_guarani',:conditions =>  cond ,:order => 'clase_id,grupo_id,nome')
